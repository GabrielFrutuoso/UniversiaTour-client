...
const DestinyCard = ({ destiny }: { destiny: Destiny}) => {
  return (
    <div className="group relative h-24 w-40 md:h-72 md:w-72 rounded-md shadow-sm overflow-hidden cursor-pointer after:w-full after:h-full after:bg-black/30 after:top-0 after:left-0 after:absolute after:hover:bg-black/50 after:transition-all after:duration-500 after:delay-100">
